...
```
git remote add upstream https://github.com/HR-Elves/race-with-friends-server.git
```
...
changes to the master (integration) branch into yours by running this command
from your branch:
